...
var TackleTestappPublicWithDeps = TC{
	...
	AnalysisTags: []api.Tag{
		...
		{Name: "Spring Properties", Category: api.Ref{Name: "Configuration Management"}},
		...
		{Name: "Spring Properties", Category: api.Ref{Name: "Sustain"}},
		{Name: "Spring Properties", Category: api.Ref{Name: "Embedded"}},
